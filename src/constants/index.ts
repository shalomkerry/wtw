...
export const tags:TagTypes[]=[
  ...
  { id: Math.random() * 1000, title: 'Documentary' },
  { id: Math.random() * 1000, title: 'Gaming' },
  { id: Math.random() * 1000, title: 'Entertainment' },
  { id: Math.random() * 1000, title: 'Lifestyle' },
  { id: Math.random() * 1000, title: 'Design' },
  { id: Math.random() * 1000, title: 'News' },
  { id: Math.random() * 1000, title: 'Spiritual' },
